...
export class SimplePublicKey extends JSONSerializable<
  ...
  public address(): string {
    return bech32.encode('jmes', bech32.toWords(this.rawAddress()));
  }

  public pubkeyAddress(): string {
    return bech32.encode('jmespub', bech32.toWords(this.encodeAminoPubkey()));
  }
}
...
export class ValConsPublicKey extends JSONSerializable<
  ...
  public address(): string {
    return bech32.encode('jmesvalcons', bech32.toWords(this.rawAddress()));
  }
