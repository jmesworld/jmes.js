...
describe('Coins', () => {
  it('clobbers coins of similar denom', () => {
    ...
    const coinLUNA = coins1.get('ujmes');
  ...
  it('allows coins to be instantiated with a variety of inputs', () => {
    ...
    // input #2: Coin[]
    const coins2 = new Coins([new Coin('ukrw', 1), new Coin('ujmes', 2)]);
    ...
    // input #4: string
    const coins4 = new Coins('2ujmes,1ukrw');
  ...
  it('fromString', () => {
    const int_coins_string = '5ukrw,12ujmes';
    const dec_coins_string = '2.3ukrw,1.45ujmes';
    const neg_dec_coins_string = '-1.0ukrw,2.5ujmes';
