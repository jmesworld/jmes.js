...
describe('MnemonicKey', () => {
  ...
  it('signature', async () => {
    ...
    const msgSend = new MsgSend(
      ...
      new Coins({ ujmes: '100000000' })
    );

    const fee = new Fee(46467, new Coins({ ujmes: '698' }));
  ...
  it('multisig', async () => {
    ...
    const signDoc = new SignDoc(
      ...
      new AuthInfo([], new Fee(50000, { ujmes: 750 })),
      new TxBody([msgSend])
    );
  ...
  it('multisend', async () => {
    ...
    const signDoc = new SignDoc(
      ...
      47,
      0,
      new AuthInfo([], new Fee(100000, { ujmes: 1500, usdr: 1000 })),
      new TxBody(
        [
          new MsgMultiSend(
            [
